  ...
  return (
    <section id="contact" className="relative">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        <div className="lg:w-2/3 md:w-1/2 bg-orange-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe
            width="100%"
            height="100%"
            title="map"
            ...
            src="https://www.google.com/maps/embed/v1/place?q=syokimau&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
          />
          <div className="bg-green-900 relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div className="lg:w-2/8 px-6 mt-4 lg:mt-0">
              <h2 className="title-font font-semibold text-white tracking-widest text-xs">
                EMAIL
              </h2>
              ...
              <p className="leading-relaxed">+254710584581</p>
            </div>
          </div>
        </div>
        <form
          ...
          <p className="leading-relaxed mb-5 text-yellow-300">
            Hello, I am open to working on projects. Fill in the form below to hire me.
          </p>
          <div className="relative mb-4">
            <label htmlFor="name" className="leading-7 text-sm text-yellow-300">
              Name
            </label>
            <input
              type="text"
          ...
          <div className="relative mb-4">
            <label htmlFor="email" className="leading-7 text-sm text-yellow-300">
              Email
            </label>
            <input
              type="email"
